...
public class RegionsUnexploredSecondaryRegionConfig {
    ...
    static {
        ...
        MID_WARM_ARID = BUILDER.define("warm_arid", "regions_unexplored:willow_forest");
        ...
        BUILDER.comment("warm_biomes");
        MID_VAR_WARM_ARID = BUILDER.define("warm_arid", "regions_unexplored:willow_forest");
        ...
        MID_VAR_WARM_WET = BUILDER.define("warm_wet", "regions_unexplored:flower_field");
        ...
        PLT_VAR_WARM_WET = BUILDER.define("warm_wet", "regions_unexplored:flower_field");
