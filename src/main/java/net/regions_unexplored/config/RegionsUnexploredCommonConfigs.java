...
public class RegionsUnexploredCommonConfigs {
    ...
    public static final ForgeConfigSpec.ConfigValue<Boolean> TOGGLE_REDSTONE_HELL;
    ...
    static {
        ...
        TOGGLE_OVERGROWN_CAVES = BUILDER.define("toggle_overgrown_caves", true);
        ...
        TOGGLE_REDSTONE_HELL = BUILDER.define("toggle_redstone_hell", true);
