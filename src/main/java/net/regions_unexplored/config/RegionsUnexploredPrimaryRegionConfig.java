...
public class RegionsUnexploredPrimaryRegionConfig {
    ...
    static {
        ...
        MID_ICY_HUMID = BUILDER.define("icy_humid", "regions_unexplored:cold_boreal_forest");
        BUILDER.comment("cool_biomes");
        MID_COOL_ARID = BUILDER.define("cool_arid", "regions_unexplored:pumpkin_fields");
        MID_COOL_DRY = BUILDER.define("cool_dry", "regions_unexplored:autumnal_maple_forest");
        MID_COOL_NEUTRAL = BUILDER.define("cool_neutral", "regions_unexplored:maple_forest");
        MID_COOL_WET = BUILDER.define("cool_wet", "regions_unexplored:maple_forest");
        MID_COOL_HUMID = BUILDER.define("cool_humid", "regions_unexplored:boreal_forest");
        BUILDER.comment("neutral_biomes");
        MID_NEUTRAL_ARID = BUILDER.define("neutral_arid", "regions_unexplored:orchard");
        MID_NEUTRAL_DRY = BUILDER.define("neutral_dry", "regions_unexplored:shrubland");
        MID_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", "regions_unexplored:temperate_grove");
        MID_NEUTRAL_WET = BUILDER.define("neutral_wet", "regions_unexplored:pine_forest");
        MID_NEUTRAL_HUMID = BUILDER.define("neutral_humid", "regions_unexplored:blackwood_forest");
        BUILDER.comment("warm_biomes");
        MID_WARM_ARID = BUILDER.define("warm_arid", "regions_unexplored:deciduous_forest");
        MID_WARM_DRY = BUILDER.define("warm_dry", "regions_unexplored:deciduous_forest");
        MID_WARM_NEUTRAL = BUILDER.define("warm_neutral", "regions_unexplored:barley_fields");
        MID_WARM_WET = BUILDER.define("warm_wet", "regions_unexplored:redwoods");
        MID_WARM_HUMID = BUILDER.define("warm_humid", "regions_unexplored:redwoods");
        BUILDER.comment("hot_biomes");
        MID_HOT_ARID = BUILDER.define("hot_arid", "regions_unexplored:baobab_savanna");
        MID_HOT_DRY = BUILDER.define("hot_dry", "regions_unexplored:baobab_savanna");
        MID_HOT_NEUTRAL = BUILDER.define("hot_neutral", "regions_unexplored:saguaro_desert");
        MID_HOT_WET = BUILDER.define("hot_wet", "regions_unexplored:saguaro_desert");
        MID_HOT_HUMID = BUILDER.define("hot_humid", "regions_unexplored:old_growth_rainforest");
        BUILDER.pop();
        BUILDER.push("-----------------MIDDLE_BIOMES_VARIANT--------------------");
        BUILDER.comment("icy_biomes");
        MID_VAR_ICY_ARID = BUILDER.define("icy_arid", "regions_unexplored:alpha_grove");
        MID_VAR_ICY_DRY = BUILDER.define("icy_dry", "regions_unexplored:frozen_tundra");
        MID_VAR_ICY_NEUTRAL = BUILDER.define("icy_neutral", "regions_unexplored:frozen_tundra");
        MID_VAR_ICY_WET = BUILDER.define("icy_wet", "regions_unexplored:cold_boreal_forest");
        MID_VAR_ICY_HUMID = BUILDER.define("icy_humid", "regions_unexplored:spires");
        BUILDER.comment("cool_biomes");
        MID_VAR_COOL_ARID = BUILDER.define("cool_arid", "regions_unexplored:autumnal_maple_forest");
        MID_VAR_COOL_DRY = BUILDER.define("cool_dry", "regions_unexplored:silver_birch_forest");
        MID_VAR_COOL_NEUTRAL = BUILDER.define("cool_neutral", "regions_unexplored:maple_forest");
        MID_VAR_COOL_WET = BUILDER.define("cool_wet", "regions_unexplored:boreal_forest");
        MID_VAR_COOL_HUMID = BUILDER.define("cool_humid", "regions_unexplored:golden_boreal_forest");
        BUILDER.comment("neutral_biomes");
        MID_VAR_NEUTRAL_ARID = BUILDER.define("neutral_arid", "regions_unexplored:orchard");
        MID_VAR_NEUTRAL_DRY = BUILDER.define("neutral_dry", "regions_unexplored:shrubland");
        MID_VAR_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", "regions_unexplored:temperate_grove");
        MID_VAR_NEUTRAL_WET = BUILDER.define("neutral_wet", "regions_unexplored:pine_forest");
        MID_VAR_NEUTRAL_HUMID = BUILDER.define("neutral_humid", "regions_unexplored:blackwood_forest");
        BUILDER.comment("warm_biomes");
        MID_VAR_WARM_ARID = BUILDER.define("warm_arid", "regions_unexplored:deciduous_forest");
        MID_VAR_WARM_DRY = BUILDER.define("warm_dry", "regions_unexplored:deciduous_forest");
        MID_VAR_WARM_NEUTRAL = BUILDER.define("warm_neutral", "regions_unexplored:prairie");
        MID_VAR_WARM_WET = BUILDER.define("warm_wet", "regions_unexplored:redwoods");
        MID_VAR_WARM_HUMID = BUILDER.define("warm_humid", "regions_unexplored:sparse_redwoods");
        BUILDER.comment("hot_biomes");
        MID_VAR_HOT_ARID = BUILDER.define("hot_arid", "regions_unexplored:baobab_savanna");
        MID_VAR_HOT_DRY = BUILDER.define("hot_dry", "regions_unexplored:baobab_savanna");
        MID_VAR_HOT_NEUTRAL = BUILDER.define("hot_neutral", "regions_unexplored:joshua_desert");
        MID_VAR_HOT_WET = BUILDER.define("hot_wet", "regions_unexplored:joshua_desert");
        MID_VAR_HOT_HUMID = BUILDER.define("hot_humid", "regions_unexplored:old_growth_rainforest");
        BUILDER.pop();

        BUILDER.push("-----------------PLATEAU_BIOMES--------------------");
        BUILDER.comment("icy_biomes");
        PLT_ICY_ARID = BUILDER.define("icy_arid", "regions_unexplored:icy_heights");
        PLT_ICY_DRY = BUILDER.define("icy_dry", "regions_unexplored:icy_heights");
        PLT_ICY_NEUTRAL = BUILDER.define("icy_neutral", "regions_unexplored:icy_heights");
        PLT_ICY_WET = BUILDER.define("icy_wet", "regions_unexplored:icy_heights");
        PLT_ICY_HUMID = BUILDER.define("icy_humid", "regions_unexplored:cold_boreal_forest");
        BUILDER.comment("cool_biomes");
        PLT_COOL_ARID = BUILDER.define("cool_arid", "regions_unexplored:autumnal_maple_forest");
        PLT_COOL_DRY = BUILDER.define("cool_dry", "regions_unexplored:autumnal_maple_forest");
        PLT_COOL_NEUTRAL = BUILDER.define("cool_neutral", "regions_unexplored:maple_forest");
        PLT_COOL_WET = BUILDER.define("cool_wet", "regions_unexplored:boreal_forest");
        PLT_COOL_HUMID = BUILDER.define("cool_humid", "regions_unexplored:boreal_forest");
        BUILDER.comment("neutral_biomes");
        PLT_NEUTRAL_ARID = BUILDER.define("neutral_arid", "regions_unexplored:highland_fields");
        PLT_NEUTRAL_DRY = BUILDER.define("neutral_dry", "regions_unexplored:highland_fields");
        PLT_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", "regions_unexplored:deciduous_forest");
        PLT_NEUTRAL_WET = BUILDER.define("neutral_wet", "regions_unexplored:highland_fields");
        PLT_NEUTRAL_HUMID = BUILDER.define("neutral_humid", "regions_unexplored:blackwood_forest");
        BUILDER.comment("warm_biomes");
        ...
        PLT_HOT_NEUTRAL = BUILDER.define("hot_neutral", "regions_unexplored:rainforest");
        PLT_HOT_WET = BUILDER.define("hot_wet", "regions_unexplored:rainforest");
        PLT_HOT_HUMID = BUILDER.define("hot_humid", "regions_unexplored:rainforest");
        BUILDER.pop();
        ...
        PLT_VAR_ICY_HUMID = BUILDER.define("icy_humid", "regions_unexplored:spires");
        BUILDER.comment("cool_biomes");
        PLT_VAR_COOL_ARID = BUILDER.define("cool_arid", "regions_unexplored:autumnal_maple_forest");
        PLT_VAR_COOL_DRY = BUILDER.define("cool_dry", "regions_unexplored:silver_birch_forest");
        PLT_VAR_COOL_NEUTRAL = BUILDER.define("cool_neutral", "regions_unexplored:maple_forest");
        PLT_VAR_COOL_WET = BUILDER.define("cool_wet", "regions_unexplored:boreal_forest");
        PLT_VAR_COOL_HUMID = BUILDER.define("cool_humid", "regions_unexplored:golden_boreal_forest");
        BUILDER.comment("neutral_biomes");
        PLT_VAR_NEUTRAL_ARID = BUILDER.define("neutral_arid", "regions_unexplored:highland_fields");
        PLT_VAR_NEUTRAL_DRY = BUILDER.define("neutral_dry", "regions_unexplored:highland_fields");
        PLT_VAR_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", "regions_unexplored:deciduous_forest");
        PLT_VAR_NEUTRAL_WET = BUILDER.define("neutral_wet", "regions_unexplored:pine_forest");
        PLT_VAR_NEUTRAL_HUMID = BUILDER.define("neutral_humid", "regions_unexplored:blackwood_forest");
        BUILDER.comment("warm_biomes");
        PLT_VAR_WARM_ARID = BUILDER.define("warm_arid", "regions_unexplored:deciduous_forest");
        PLT_VAR_WARM_DRY = BUILDER.define("warm_dry", "regions_unexplored:deciduous_forest");
        PLT_VAR_WARM_NEUTRAL = BUILDER.define("warm_neutral", "regions_unexplored:deciduous_forest");
        PLT_VAR_WARM_WET = BUILDER.define("warm_wet", "regions_unexplored:redwoods");
        PLT_VAR_WARM_HUMID = BUILDER.define("warm_humid", "regions_unexplored:sparse_redwoods");
        BUILDER.comment("hot_biomes");
        ...
        PLT_VAR_HOT_NEUTRAL = BUILDER.define("hot_neutral", "regions_unexplored:rainforest");
        PLT_VAR_HOT_WET = BUILDER.define("hot_wet", "regions_unexplored:old_growth_rainforest");
        PLT_VAR_HOT_HUMID = BUILDER.define("hot_humid", "regions_unexplored:rainforest");
        BUILDER.pop();

        BUILDER.push("-----------------SHATTERED_BIOMES--------------------");
        BUILDER.comment("icy_biomes");
        SHT_ICY_ARID = BUILDER.define("icy_arid", "regions_unexplored:icy_heights");
        SHT_ICY_DRY = BUILDER.define("icy_dry", "regions_unexplored:icy_heights");
        SHT_ICY_NEUTRAL = BUILDER.define("icy_neutral", "regions_unexplored:icy_heights");
        SHT_ICY_WET = BUILDER.define("icy_wet", "regions_unexplored:icy_heights");
        SHT_ICY_HUMID = BUILDER.define("icy_humid", "regions_unexplored:icy_heights");
        BUILDER.comment("cool_biomes");
        SHT_COOL_ARID = BUILDER.define("cool_arid", "regions_unexplored:towering_cliffs");
        SHT_COOL_DRY = BUILDER.define("cool_dry", "regions_unexplored:towering_cliffs");
        SHT_COOL_NEUTRAL = BUILDER.define("cool_neutral", "regions_unexplored:towering_cliffs");
        SHT_COOL_WET = BUILDER.define("cool_wet", "regions_unexplored:towering_cliffs");
        SHT_COOL_HUMID = BUILDER.define("cool_humid", "regions_unexplored:towering_cliffs");
        BUILDER.comment("neutral_biomes");
        SHT_NEUTRAL_ARID = BUILDER.define("neutral_arid", "regions_unexplored:lush_hills");
        SHT_NEUTRAL_DRY = BUILDER.define("neutral_dry", "regions_unexplored:lush_hills");
        SHT_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", "regions_unexplored:lush_hills");
        SHT_NEUTRAL_WET = BUILDER.define("neutral_wet", "regions_unexplored:lush_hills");
        SHT_NEUTRAL_HUMID = BUILDER.define("neutral_humid", "regions_unexplored:lush_hills");
        BUILDER.comment("warm_biomes");
        SHT_WARM_ARID = BUILDER.define("warm_arid", "regions_unexplored:deciduous_forest");
        SHT_WARM_DRY = BUILDER.define("warm_dry", "regions_unexplored:deciduous_forest");
        SHT_WARM_NEUTRAL = BUILDER.define("warm_neutral", "regions_unexplored:prairie");
        SHT_WARM_WET = BUILDER.define("warm_wet", "regions_unexplored:sparse_redwoods");
        SHT_WARM_HUMID = BUILDER.define("warm_humid", "regions_unexplored:sparse_redwoods");
        BUILDER.comment("hot_biomes");
        SHT_HOT_ARID = BUILDER.define("hot_arid", "regions_unexplored:baobab_savanna");
        SHT_HOT_DRY = BUILDER.define("hot_dry", "regions_unexplored:baobab_savanna");
        SHT_HOT_NEUTRAL = BUILDER.define("hot_neutral", "regions_unexplored:saguaro_desert");
        SHT_HOT_WET = BUILDER.define("hot_wet", "regions_unexplored:saguaro_desert");
        SHT_HOT_HUMID = BUILDER.define("hot_humid", "regions_unexplored:rainforest");
        BUILDER.pop();

        BUILDER.push("-----------------SLOPE_BIOMES--------------------");
        BUILDER.comment("slope_biomes");
        ICY_SLOPE = BUILDER.define("icy_slope_biome", "minecraft:snowy_slopes");
        COOL_SLOPE = BUILDER.define("cold_slope_biome", "regions_unexplored:pine_slopes");
        NEUTRAL_SLOPE = BUILDER.define("neutral_slope_biome", "regions_unexplored:pine_slopes");
        WARM_SLOPE = BUILDER.define("warm_slope_biome", "regions_unexplored:deciduous_forest");
        HOT_SLOPE = BUILDER.define("hot_slope_biome", "regions_unexplored:rainforest");
        BUILDER.comment("slope_biomes_variant");
        ICY_SLOPE_VAR = BUILDER.define("icy_slope_biome_variant", "regions_unexplored:cold_deciduous_forest");
        COOL_SLOPE_VAR = BUILDER.define("cold_slope_biome_variant", "regions_unexplored:pine_slopes");
        NEUTRAL_SLOPE_VAR = BUILDER.define("neutral_slope_biome_variant", "regions_unexplored:pine_slopes");
        WARM_SLOPE_VAR = BUILDER.define("warm_slope_biome_variant", "regions_unexplored:deciduous_forest");
        HOT_SLOPE_VAR = BUILDER.define("hot_slope_biome_variant", "regions_unexplored:rainforest");
        BUILDER.pop();

        BUILDER.push("-----------------PEAK_BIOMES--------------------");
        BUILDER.comment("peak_biomes");
        ICY_PEAK = BUILDER.define("icy_peak_biome", "minecraft:frozen_peaks");
        COOL_PEAK = BUILDER.define("cold_peak_biome", "minecraft:jagged_peaks");
        NEUTRAL_PEAK = BUILDER.define("neutral_peak_biome", "regions_unexplored:mountains");
        WARM_PEAK = BUILDER.define("warm_peak_biome", "minecraft:stony_peaks");
        HOT_PEAK = BUILDER.define("hot_peak_biome", "regions_unexplored:arid_mountains");
        BUILDER.comment("peak_biomes_variant");
        ICY_PEAK_VAR = BUILDER.define("icy_peak_biome_variant", "minecraft:jagged_peaks");
        COOL_PEAK_VAR = BUILDER.define("cold_peak_biome_variant", "regions_unexplored:mountains");
        NEUTRAL_PEAK_VAR = BUILDER.define("neutral_peak_biome_variant", "regions_unexplored:mountains");
        WARM_PEAK_VAR = BUILDER.define("warm_peak_biome_variant", "minecraft:stony_peaks");
        HOT_PEAK_VAR = BUILDER.define("hot_peak_biome_variant", "regions_unexplored:arid_mountains");
        BUILDER.pop();

        BUILDER.push("-----------------RIVER_BIOMES--------------------");
        BUILDER.comment("icy_biomes");
        RVR_ICY_ARID = BUILDER.define("icy_arid", "minecraft:frozen_river");
        RVR_ICY_DRY = BUILDER.define("icy_dry", "minecraft:frozen_river");
        RVR_ICY_NEUTRAL = BUILDER.define("icy_neutral", "minecraft:frozen_river");
        RVR_ICY_WET = BUILDER.define("icy_wet", "minecraft:frozen_river");
        RVR_ICY_HUMID = BUILDER.define("icy_humid", "minecraft:frozen_river");
        BUILDER.comment("cool_biomes");
        RVR_COOL_ARID = BUILDER.define("cool_arid", "regions_unexplored:cold_river");
        RVR_COOL_DRY = BUILDER.define("cool_dry", "regions_unexplored:cold_river");
        RVR_COOL_NEUTRAL = BUILDER.define("cool_neutral", "regions_unexplored:cold_river");
        RVR_COOL_WET = BUILDER.define("cool_wet", "regions_unexplored:cold_river");
        RVR_COOL_HUMID = BUILDER.define("cool_humid", "regions_unexplored:cold_river");
        BUILDER.comment("neutral_biomes");
        RVR_NEUTRAL_ARID = BUILDER.define("neutral_arid", "regions_unexplored:muddy_river");
        RVR_NEUTRAL_DRY = BUILDER.define("neutral_dry", "regions_unexplored:muddy_river");
        RVR_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", "regions_unexplored:muddy_river");
        RVR_NEUTRAL_WET = BUILDER.define("neutral_wet", "regions_unexplored:muddy_river");
        RVR_NEUTRAL_HUMID = BUILDER.define("neutral_humid", "regions_unexplored:blackwood_forest");
        BUILDER.comment("warm_biomes");
        RVR_WARM_ARID = BUILDER.define("warm_arid", "regions_unexplored:muddy_river");
        RVR_WARM_DRY = BUILDER.define("warm_dry", "regions_unexplored:muddy_river");
        RVR_WARM_NEUTRAL = BUILDER.define("warm_neutral", "regions_unexplored:muddy_river");
        RVR_WARM_WET = BUILDER.define("warm_wet", "regions_unexplored:muddy_river");
        RVR_WARM_HUMID = BUILDER.define("warm_humid", "regions_unexplored:muddy_river");
        BUILDER.comment("hot_biomes");
        ...
        BUILDER.comment("icy_biomes");
        RVR_VAR_ICY_ARID = BUILDER.define("icy_arid", "minecraft:frozen_river");
        RVR_VAR_ICY_DRY = BUILDER.define("icy_dry", "minecraft:frozen_river");
        RVR_VAR_ICY_NEUTRAL = BUILDER.define("icy_neutral", "minecraft:frozen_river");
        RVR_VAR_ICY_WET = BUILDER.define("icy_wet", "minecraft:frozen_river");
        RVR_VAR_ICY_HUMID = BUILDER.define("icy_humid", "minecraft:frozen_river");
        BUILDER.comment("cool_biomes");
        RVR_VAR_COOL_ARID = BUILDER.define("cool_arid", "regions_unexplored:cold_river");
        RVR_VAR_COOL_DRY = BUILDER.define("cool_dry", "regions_unexplored:cold_river");
        RVR_VAR_COOL_NEUTRAL = BUILDER.define("cool_neutral", "regions_unexplored:cold_river");
        RVR_VAR_COOL_WET = BUILDER.define("cool_wet", "regions_unexplored:cold_river");
        RVR_VAR_COOL_HUMID = BUILDER.define("cool_humid", "regions_unexplored:cold_river");
        BUILDER.comment("neutral_biomes");
        RVR_VAR_NEUTRAL_ARID = BUILDER.define("neutral_arid", "regions_unexplored:muddy_river");
        RVR_VAR_NEUTRAL_DRY = BUILDER.define("neutral_dry", "regions_unexplored:muddy_river");
        RVR_VAR_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", "regions_unexplored:muddy_river");
        RVR_VAR_NEUTRAL_WET = BUILDER.define("neutral_wet", "regions_unexplored:muddy_river");
        RVR_VAR_NEUTRAL_HUMID = BUILDER.define("neutral_humid", "regions_unexplored:blackwood_forest");
        BUILDER.comment("warm_biomes");
        RVR_VAR_WARM_ARID = BUILDER.define("warm_arid", "regions_unexplored:muddy_river");
        RVR_VAR_WARM_DRY = BUILDER.define("warm_dry", "regions_unexplored:muddy_river");
        RVR_VAR_WARM_NEUTRAL = BUILDER.define("warm_neutral", "regions_unexplored:muddy_river");
        RVR_VAR_WARM_WET = BUILDER.define("warm_wet", "regions_unexplored:muddy_river");
        RVR_VAR_WARM_HUMID = BUILDER.define("warm_humid", "regions_unexplored:muddy_river");
        BUILDER.comment("hot_biomes");
        ...
        BUILDER.comment("icy_biomes");
        SMP_ICY_ARID = BUILDER.define("icy_arid", "regions_unexplored:spires");
        SMP_ICY_DRY = BUILDER.define("icy_dry", "regions_unexplored:spires");
        SMP_ICY_NEUTRAL = BUILDER.define("icy_neutral", "regions_unexplored:spires");
        SMP_ICY_WET = BUILDER.define("icy_wet", "regions_unexplored:spires");
        SMP_ICY_HUMID = BUILDER.define("icy_humid", "regions_unexplored:spires");
        BUILDER.comment("cool_biomes");
        SMP_COOL_ARID = BUILDER.define("cool_arid", "regions_unexplored:fen");
        SMP_COOL_DRY = BUILDER.define("cool_dry", "regions_unexplored:fen");
        SMP_COOL_NEUTRAL = BUILDER.define("cool_neutral", "regions_unexplored:fen");
        SMP_COOL_WET = BUILDER.define("cool_wet", "regions_unexplored:fen");
        SMP_COOL_HUMID = BUILDER.define("cool_humid", "regions_unexplored:fen");
        BUILDER.comment("neutral_biomes");
        SMP_NEUTRAL_ARID = BUILDER.define("neutral_arid", "regions_unexplored:bayou");
        SMP_NEUTRAL_DRY = BUILDER.define("neutral_dry", "regions_unexplored:bayou");
        SMP_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", "regions_unexplored:bayou");
        SMP_NEUTRAL_WET = BUILDER.define("neutral_wet", "regions_unexplored:giant_bayou");
        SMP_NEUTRAL_HUMID = BUILDER.define("neutral_humid", "regions_unexplored:giant_bayou");
        BUILDER.comment("warm_biomes");
        SMP_WARM_ARID = BUILDER.define("warm_arid", "regions_unexplored:flooded_plains");
        SMP_WARM_DRY = BUILDER.define("warm_dry", "regions_unexplored:flooded_plains");
        SMP_WARM_NEUTRAL = BUILDER.define("warm_neutral", "regions_unexplored:flooded_plains");
        ...
        OCA_DEP_HOT = BUILDER.define("deep_hot", "minecraft:warm_ocean");
        BUILDER.comment("oceans");
        OCA_ICY = BUILDER.define("icy", "minecraft:frozen_ocean");
        ...
        CAVE_1 = BUILDER.define("cave_1_biome", "minecraft:lush_caves");
        CAVE_2 = BUILDER.define("cave_2_biome", "minecraft:dripstone_caves");
        CAVE_3 = BUILDER.define("cave_3_biome", "minecraft:deep_dark");
        CAVE_4 = BUILDER.define("cave_4_biome", "regions_unexplored:bioshroom_caves");
        CAVE_5 = BUILDER.define("cave_5_biome", "regions_unexplored:lush_delta");
        CAVE_6 = BUILDER.define("cave_6_biome", "regions_unexplored:prismachasm");
        CAVE_7 = BUILDER.define("cave_7_biome", "regions_unexplored:redstone_caves");
