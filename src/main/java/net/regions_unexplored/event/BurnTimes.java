...
public class BurnTimes {
    ...
    public static void burnTime(FurnaceFuelBurnTimeEvent event) {
        ...
        if (
                        ...
                        item == RegionsUnexploredBlocks.LIGHT_GREY_PAINTED_PLANKS.get().asItem()||
                        item == RegionsUnexploredBlocks.GREY_PAINTED_PLANKS.get().asItem()||
                        ...
                        item == RegionsUnexploredBlocks.LIGHT_GREY_PAINTED_STAIRS.get().asItem()||
                        item == RegionsUnexploredBlocks.GREY_PAINTED_STAIRS.get().asItem()||
        ...
        if (
                        ...
                        item == RegionsUnexploredBlocks.LIGHT_GREY_PAINTED_SLAB.get().asItem()||
                        item == RegionsUnexploredBlocks.GREY_PAINTED_SLAB.get().asItem()||
