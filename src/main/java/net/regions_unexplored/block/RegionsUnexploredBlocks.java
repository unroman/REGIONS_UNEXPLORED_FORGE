...
public class RegionsUnexploredBlocks {
    ...
    //CAVE
    public static final RegistryObject<Block> PRISMOSS = registerBlock("prismoss", () -> new StoneGrassBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_GREEN).sound(SoundType.STONE).randomTicks().strength(1.5f, 6f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> DEEPSLATE_PRISMOSS = registerBlock("deepslate_prismoss", () -> new DeepslateGrassBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_GREEN).sound(SoundType.DEEPSLATE).randomTicks().strength(3f, 6f).requiresCorrectToolForDrops()));
    ...
    //FLOWERS
    public static final RegistryObject<Block> BLUE_LUPINE = registerBlock("blue_lupine", () -> new FlowerBlock(MobEffects.SATURATION, 4, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> PINK_LUPINE = registerBlock("pink_lupine", () -> new FlowerBlock(MobEffects.SATURATION, 4, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> PURPLE_LUPINE = registerBlock("purple_lupine", () -> new FlowerBlock(MobEffects.SATURATION, 4, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> RED_LUPINE = registerBlock("red_lupine", () -> new FlowerBlock(MobEffects.SATURATION, 4, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> YELLOW_LUPINE = registerBlock("yellow_lupine", () -> new FlowerBlock(MobEffects.SATURATION, 4, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> HYSSOP = registerBlock("hyssop", () -> new FlowerBlock(MobEffects.LUCK, 10, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> FIREWEED = registerBlock("fireweed", () -> new FlowerBlock(MobEffects.GLOWING, 2, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> DAISY = registerBlock("daisy", () -> new FlowerBlock(MobEffects.MOVEMENT_SPEED, 8, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> FELICIA_DAISY = registerBlock("felicia_daisy", () -> new FlowerBlock(MobEffects.MOVEMENT_SPEED, 8, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> WARATAH = registerBlock("waratah", () -> new FlowerBlock(MobEffects.JUMP, 5, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> WHITE_TRILLIUM = registerBlock("white_trillium", () -> new FlowerBlock(MobEffects.DIG_SPEED, 7, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> POPPY_BUSH = registerBlock("poppy_bush", () -> new FlowerBlock(MobEffects.WEAKNESS, 3, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> ALPHA_ROSE = registerBlock("alpha_rose", () -> new FlowerBlock(MobEffects.JUMP, 5, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> ALPHA_DANDELION = registerBlock("alpha_dandelion", () -> new FlowerBlock(MobEffects.JUMP, 5, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> WILTING_TRILLIUM = registerBlock("wilting_trillium", () -> new FlowerBlock(MobEffects.DIG_SLOWDOWN, 4, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> TASSEL = registerBlock("tassel", () -> new RuDoublePlantBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TSUBAKI = registerBlock("tsubaki", () -> new RuDoublePlantBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    //OTHER
    ...
    public static final RegistryObject<Block> CATTAIL = registerBlock("cattail", () -> new RuDoublePlantBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    //BAMBOO_BLOCKS
    ...
    public static final RegistryObject<Block> APPLE_OAK_LEAVES = registerBlock("apple_oak_leaves", () ->  leaves(MaterialColor.PLANT));
    ...
    public static final RegistryObject<Block> JOSHUA_LEAVES = registerBlock("joshua_leaves", () ->  leaves(MaterialColor.PLANT));
    ...
    public static final RegistryObject<Block> BAOBAB_TRAPDOOR = registerBlock("baobab_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(RegionsUnexploredBlocks::never), SoundEvents.WOODEN_DOOR_CLOSE, SoundEvents.WOODEN_DOOR_OPEN));
    ...
    public static final RegistryObject<Block> BLACKWOOD_TRAPDOOR = registerBlock("blackwood_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLACK).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(RegionsUnexploredBlocks::never), SoundEvents.WOODEN_DOOR_CLOSE, SoundEvents.WOODEN_DOOR_OPEN));
    ...
    public static final RegistryObject<Block> CHERRY_TRAPDOOR = registerBlock("cherry_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(RegionsUnexploredBlocks::never), SoundEvents.WOODEN_DOOR_CLOSE, SoundEvents.WOODEN_DOOR_OPEN));
    ...
    public static final RegistryObject<Block> MAUVE_TRAPDOOR = registerBlock("mauve_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PURPLE).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(RegionsUnexploredBlocks::never), SoundEvents.WOODEN_DOOR_CLOSE, SoundEvents.WOODEN_DOOR_OPEN));
    ...
    public static final RegistryObject<Block> LIGHT_GREY_PAINTED_PLANKS = registerBlock("light_grey_painted_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_LIGHT_GRAY).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> LIGHT_GREY_PAINTED_STAIRS = registerBlock("light_grey_painted_stairs", () -> woodStairs(MaterialColor.COLOR_LIGHT_GRAY));
    public static final RegistryObject<Block> LIGHT_GREY_PAINTED_SLAB = registerBlock("light_grey_painted_slab", () -> woodSlab(MaterialColor.COLOR_LIGHT_GRAY));
    public static final RegistryObject<Block> GREY_PAINTED_PLANKS = registerBlock("grey_painted_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_GRAY).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> GREY_PAINTED_STAIRS = registerBlock("grey_painted_stairs", () -> woodStairs(MaterialColor.COLOR_GRAY));
    public static final RegistryObject<Block> GREY_PAINTED_SLAB = registerBlock("grey_painted_slab", () -> woodSlab(MaterialColor.COLOR_GRAY));
    ...
    public static final RegistryObject<Block> SCULKWOOD_DOOR = registerBlock("sculkwood_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).strength(3.0F).sound(SoundType.WOOD).noOcclusion(), SoundEvents.WOODEN_DOOR_CLOSE, SoundEvents.WOODEN_DOOR_OPEN));
    ...
    public static final RegistryObject<Block> SCULKWOOD_TRAPDOOR = registerBlock("sculkwood_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(RegionsUnexploredBlocks::never), SoundEvents.WOODEN_DOOR_CLOSE, SoundEvents.WOODEN_DOOR_OPEN));
