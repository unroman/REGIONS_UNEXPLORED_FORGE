...
public class RegionsUnexploredBlocks {
    ...
    public static final RegistryObject<Block> TALL_ACACIA_SAPLING = registerBlock("tall_acacia_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_BAOBAB_SAPLING = registerBlock("tall_baobab_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_BIRCH_SAPLING = registerBlock("tall_birch_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_BLACKWOOD_SAPLING = registerBlock("tall_blackwood_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_CHERRY_SAPLING = registerBlock("tall_cherry_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_RED_CHERRY_SAPLING = registerBlock("tall_red_cherry_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_PINK_CHERRY_SAPLING = registerBlock("tall_pink_cherry_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_WHITE_CHERRY_SAPLING = registerBlock("tall_white_cherry_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> TALL_DARK_OAK_SAPLING = registerBlock("tall_dark_oak_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_DEAD_SAPLING = registerBlock("tall_dead_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_DEAD_PINE_SAPLING = registerBlock("tall_dead_pine_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> TALL_FLOWERING_SAPLING = registerBlock("tall_flowering_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_JOSHUA_SAPLING = registerBlock("tall_joshua_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> TALL_MANGROVE_SAPLING = registerBlock("tall_mangrove_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> TALL_OAK_SAPLING = registerBlock("tall_oak_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> TALL_PALM_SAPLING = registerBlock("tall_palm_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> TALL_WILLOW_SAPLING = registerBlock("tall_willow_sapling", () -> new TallSaplingBlock(BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    //BRANCHES_DONE
