...
public class RegionsUnexploredBiomes {
    ...
    public static void bootstrap(BootstapContext<Biome> context) {
        ...
        register(context, RuBiomes.HYACINTH_DEEPS, RuOceanBiomes.hyacinthDeeps(featuresGetter, carversGetter));
        register(context, RuBiomes.ROCKY_REEF, RuOceanBiomes.rockyReef(featuresGetter, carversGetter));
