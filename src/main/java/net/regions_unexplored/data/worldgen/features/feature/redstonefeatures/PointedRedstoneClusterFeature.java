...
public class PointedRedstoneClusterFeature extends Feature<PointedRedstoneClusterConfiguration> {
    ...
    private boolean canPlacePool(WorldGenLevel level, BlockPos pos) {
        ...
        if (!blockstate.is(Blocks.RED_TERRACOTTA) && !blockstate.is(RegionsUnexploredBlocks.RAW_REDSTONE_BLOCK.get()) && !blockstate.is(RegionsUnexploredBlocks.POINTED_REDSTONE.get())) {
