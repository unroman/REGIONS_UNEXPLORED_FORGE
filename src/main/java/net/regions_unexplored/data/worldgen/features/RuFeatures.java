...
public class RuFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, RU_DISK_MUD, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(RegionsUnexploredBlocks.FOREST_MUD.get()), BlockPredicate.matchesBlocks(List.of(RegionsUnexploredBlocks.FOREST_MUD.get(), RegionsUnexploredBlocks.FOREST_DIRT.get(), RegionsUnexploredBlocks.PLAINS_DIRT.get(), Blocks.DIRT, Blocks.CLAY)), UniformInt.of(2, 3), 1));
        ...
        register(context, RU_DISK_MUD_BIG, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(RegionsUnexploredBlocks.FOREST_MUD.get()), BlockPredicate.matchesBlocks(List.of(RegionsUnexploredBlocks.FOREST_MUD.get(), RegionsUnexploredBlocks.FOREST_DIRT.get(), RegionsUnexploredBlocks.PLAINS_DIRT.get(), RegionsUnexploredBlocks.FOREST_GRASS_BLOCK.get(), RegionsUnexploredBlocks.PLAINS_GRASS_BLOCK.get(), Blocks.DIRT, Blocks.GRASS_BLOCK, Blocks.SAND)), UniformInt.of(2, 6), 2));
        ...
        register(context, NETHER_ROCK, RuFeatureRegistry.NETHER_MEADOW_ROCK.get(), new BlockStateConfiguration(RegionsUnexploredBlocks.MARROWSTONE.get().defaultBlockState()));
        register(context, MEADOW_ROCKS, RuFeatureRegistry.MEADOW_ROCKS_FEATURE.get(), FeatureConfiguration.NONE);
        register(context, SPIRES, RuFeatureRegistry.SPIRE_FEATURE.get(), FeatureConfiguration.NONE);
        ...
        register(context, HANGING_PRISMARITE_CLUSTER, RuFeatureRegistry.HANGING_PRISMARITE.get(), FeatureConfiguration.NONE);
        register(context, LAVA_FALL, RuFeatureRegistry.LAVA_FALL.get(), FeatureConfiguration.NONE);
        register(context, OVERWORLD_LAVA_DELTA, RuFeatureRegistry.OVERWORLD_LAVA_DELTA.get(), new VegetationPatchConfiguration(BlockTags.LUSH_GROUND_REPLACEABLE, BlockStateProvider.simple(RegionsUnexploredBlocks.VOLCANIC_ASH.get().defaultBlockState().setValue(AshBlock.HAS_GRAVITY, false)), PlacementUtils.inlinePlaced(holderGetter.getOrThrow(CaveFeatures.POINTED_DRIPSTONE)), CaveSurface.FLOOR, ConstantInt.of(3), 0.8F, 5, 0.1F, UniformInt.of(4, 7), 0.7F));
        register(context, ASH_VENT, RuFeatureRegistry.ASH_VENT.get(), FeatureConfiguration.NONE);
        register(context, BASALT_BLOB, RuFeatureRegistry.BASALT_BLOB.get(), new ColumnFeatureConfiguration(ConstantInt.of(1), UniformInt.of(1, 4)));
        ...
        register(context, LARGE_POINTED_REDSTONE, RuFeatureRegistry.LARGE_POINTED_REDSTONE.get(), new LargePointedRedstoneConfiguration(30, UniformInt.of(1, 6), UniformFloat.of(0.4F, 2.0F), 0.33F, UniformFloat.of(0.3F, 0.9F), UniformFloat.of(0.4F, 1.0F), UniformFloat.of(0.0F, 0.3F), 4, 0.6F));
        register(context, POINTED_REDSTONE_CLUSTER, RuFeatureRegistry.POINTED_REDSTONE_CLUSTER.get(), new PointedRedstoneClusterConfiguration(12, UniformInt.of(3, 6), UniformInt.of(2, 8), 1, 3, UniformInt.of(2, 4), UniformFloat.of(0.3F, 0.7F), ClampedNormalFloat.of(0.1F, 0.3F, 0.1F, 0.9F), 0.1F, 3, 8));
        ...
        register(context, LARGE_POINTED_REDSTONE_NETHER, RuFeatureRegistry.LARGE_POINTED_REDSTONE.get(), new LargePointedRedstoneConfiguration(30, UniformInt.of(1, 6), UniformFloat.of(0.4F, 2.0F), 0.33F, UniformFloat.of(0.3F, 0.9F), UniformFloat.of(0.4F, 1.0F), UniformFloat.of(0.0F, 0.3F), 4, 0.6F));
        register(context, POINTED_REDSTONE_CLUSTER_NETHER, RuFeatureRegistry.POINTED_REDSTONE_CLUSTER.get(), new PointedRedstoneClusterConfiguration(12, UniformInt.of(3, 6), UniformInt.of(2, 8), 1, 3, UniformInt.of(2, 4), UniformFloat.of(0.3F, 0.7F), ClampedNormalFloat.of(0.0F, 0.0F, 0.0F, 0.0F), 0.1F, 3, 8));

        register(context, ORE_REDSTONE_LARGE, Feature.ORE, new OreConfiguration(ORE_REDSTONE_TARGET_LIST, 20));
        register(context, MINERAL_VEGETATION, Feature.VEGETATION_PATCH, new VegetationPatchConfiguration(BlockTags.MOSS_REPLACEABLE, BlockStateProvider.simple(RegionsUnexploredBlocks.FOREST_GRASS_BLOCK.get()), PlacementUtils.inlinePlaced(holderGetter.getOrThrow(RuVegetationFeatures.UNDERGROUND_GRASS)), CaveSurface.FLOOR, ConstantInt.of(1), 0.0F, 5, 0.8F, UniformInt.of(4, 7), 0.3F));
        ...
        register(context, OBSIDIAN_SPIRE, RuFeatureRegistry.OBSIDIAN_SPIRE.get(), FeatureConfiguration.NONE);
        register(context, ROCK_PILLAR, RuFeatureRegistry.ROCK_PILLAR.get(), FeatureConfiguration.NONE);
    }
