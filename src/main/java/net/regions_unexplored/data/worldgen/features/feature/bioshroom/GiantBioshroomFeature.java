...
public class GiantBioshroomFeature extends Feature<HugeFungusConfiguration> {
    private static final float HUGE_PROBABILITY = 0.06F;

    public GiantBioshroomFeature(Codec<HugeFungusConfiguration> p_65922_) {
        super(p_65922_);
    }
    ...
    public boolean place(FeaturePlaceContext<HugeFungusConfiguration> p_159878_) {
        ...
        if (worldgenlevel.getBlockState(blockpos.below()).is(RegionsUnexploredTags.BIOSHROOM_GROW_BLOCK)) {
            blockpos1 = blockpos;
        }
    ...
    private static boolean isReplaceable(LevelAccessor p_65924_, BlockPos p_65925_, boolean p_65926_) {
        return p_65924_.isStateAtPosition(p_65925_, (p_248482_) -> {
            Material material = p_248482_.getMaterial();
            return p_248482_.canBeReplaced() || p_65926_ && material == Material.PLANT;
        });
    }
