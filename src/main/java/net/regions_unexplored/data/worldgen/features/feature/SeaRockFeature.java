...
public class SeaRockFeature extends Feature<SeaRockConfiguration> {
        ...
        private void setIcebergBlock(BlockPos p_225125_, LevelAccessor p_225126_, RandomSource p_225127_, int p_225128_, int p_225129_, boolean p_225130_, boolean p_225131_, BlockState p_225132_, BlockState p_225132_1) {
            ...
            if (blockstate.getMaterial() == Material.AIR || blockstate.is(Blocks.SNOW_BLOCK) || blockstate.is(Blocks.ICE) || p_225126_.getFluidState(p_225125_).is(Fluids.WATER)) {
        ...
        private static boolean isRockState(BlockState p_159886_) {
            return p_159886_.is(Blocks.STONE) || p_159886_.is(RegionsUnexploredBlocks.HYACINTH_STONE.get()) || p_159886_.is(Blocks.PACKED_ICE)|| p_159886_.is(Blocks.MOSS_BLOCK);
        }

        private boolean belowIsAir(BlockGetter p_66046_, BlockPos p_66047_) {
            return p_66046_.getBlockState(p_66047_.below()).getMaterial() == Material.AIR||p_66046_.getBlockState(p_66047_.below()).getMaterial() == Material.WATER;
        }
