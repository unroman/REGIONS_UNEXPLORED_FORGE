...
public class BlockFeatureCompat {
    ...
    public static void setup() {
        ...
        registerCompostableItems(0.65F, RegionsUnexploredBlocks.GREEN_BIOSHROOM.get());
        registerCompostableItems(0.65F, RegionsUnexploredBlocks.BLUE_BIOSHROOM.get());
        registerCompostableItems(0.65F, RegionsUnexploredBlocks.PINK_BIOSHROOM.get());
        registerCompostableItems(0.65F, RegionsUnexploredBlocks.YELLOW_BIOSHROOM.get());
