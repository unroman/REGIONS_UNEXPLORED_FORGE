...
public class RegionModifiedVanillaBiomeBuilder {
    ...
    private final ResourceKey<Biome>[][] VANILLA_RIVER_BIOMES = new ResourceKey[][]{
            ...
            {Biomes.RIVER, Biomes.RIVER, Biomes.RIVER, Biomes.RIVER, Biomes.RIVER},
            {Biomes.RIVER, Biomes.RIVER, Biomes.RIVER, Biomes.RIVER, RuBiomes.TROPICS},
            {Biomes.RIVER, Biomes.RIVER, Biomes.RIVER, Biomes.RIVER, Biomes.RIVER}};
    ...
    private final ResourceKey<Biome>[][] MIDDLE_BIOMES_VARIANT = new ResourceKey[][]{
            //-----------ARID,DRY,NEUTRAL,WET,HUMID
            /*ICY*/     {Biomes.ICE_SPIKES, RuBiomes.FROZEN_TUNDRA, Biomes.SNOWY_TAIGA, Biomes.SNOWY_TAIGA, Biomes.TAIGA},
            /*COOL*/    {Biomes.PLAINS, Biomes.PLAINS, Biomes.FOREST, Biomes.TAIGA, Biomes.OLD_GROWTH_PINE_TAIGA},
            /*NEUTRAL*/ {Biomes.FLOWER_FOREST, Biomes.PLAINS, Biomes.FOREST, Biomes.OLD_GROWTH_BIRCH_FOREST, Biomes.DARK_FOREST},
            /*WARM*/    {Biomes.SAVANNA, Biomes.SAVANNA, RuBiomes.GRASSLAND, Biomes.SPARSE_JUNGLE, Biomes.BAMBOO_JUNGLE},
            /*HOT*/     {RuBiomes.JOSHUA_DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, RuBiomes.SAGUARO_DESERT}};
    ...
    private final ResourceKey<Biome>[][] SHATTERED_BIOMES = new ResourceKey[][]{
            ...
            /*COOL*/    {RuBiomes.TOWERING_CLIFFS, RuBiomes.TOWERING_CLIFFS, RuBiomes.TOWERING_CLIFFS, Biomes.WINDSWEPT_HILLS, Biomes.WINDSWEPT_GRAVELLY_HILLS},
            /*NEUTRAL*/ {Biomes.WINDSWEPT_FOREST, Biomes.WINDSWEPT_FOREST, Biomes.WINDSWEPT_HILLS, Biomes.WINDSWEPT_HILLS, Biomes.WINDSWEPT_GRAVELLY_HILLS},
            /*WARM*/    {Biomes.SAVANNA, Biomes.SAVANNA, RuBiomes.LUSH_HILLS, RuBiomes.LUSH_HILLS, RuBiomes.LUSH_HILLS},
            /*HOT*/     {RuBiomes.JOSHUA_DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, RuBiomes.SAGUARO_DESERT}};
    ...
    private final ResourceKey<Biome>[][] RIVER_BIOMES = new ResourceKey[][]{
            ...
            /*WARM*/    {RuBiomes.MUDDY_RIVER, RuBiomes.MUDDY_RIVER, RuBiomes.MUDDY_RIVER, RuBiomes.TROPICS, RuBiomes.TROPICS},
    ...
    private ResourceKey<Biome> maybePickToweringCliffsBiome(int temperature, int humidity, Climate.Parameter weirdness, ResourceKey<Biome> fallbackBiome) {
        ResourceKey<Biome> biome = CheckBiomeConfig.isBiomeEnabled(RuBiomes.TOWERING_CLIFFS) ? RuBiomes.TOWERING_CLIFFS : Biomes.WINDSWEPT_SAVANNA;
        ResourceKey<Biome> biomeHot = Biomes.WINDSWEPT_SAVANNA;
        if(temperature > 1 && temperature < 4){
            return humidity < 4 && weirdness.max() >= 0L ? biome : fallbackBiome;
        }
        else if(temperature==4){
            return temperature == 4 && humidity < 4 && weirdness.max() >= 0L ? biomeHot : fallbackBiome;
        }
        return temperature == 4 && humidity < 4 && weirdness.max() >= 0L ? biomeHot : fallbackBiome;
    }
