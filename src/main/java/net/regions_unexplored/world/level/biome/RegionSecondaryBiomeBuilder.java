...
public class RegionSecondaryBiomeBuilder {
    ...
    private final ResourceKey<Biome>[][] MIDDLE_BIOMES = RegionUtil.getSecondaryMiddleBiome();
    private final ResourceKey<Biome>[][] MIDDLE_BIOMES_VARIANT = RegionUtil.getSecondaryMiddleBiomeVariant();
    private final ResourceKey<Biome>[][] PLATEAU_BIOMES = RegionUtil.getSecondaryPlateauBiome();
    private final ResourceKey<Biome>[][] PLATEAU_BIOMES_VARIANT = RegionUtil.getSecondaryPlateauBiomeVariant();
    private final ResourceKey<Biome>[][] SHATTERED_BIOMES = RegionUtil.getSecondaryShatteredBiome();
    private final ResourceKey<Biome>[][] RIVER_BIOMES = RegionUtil.getSecondaryRiverBiome();
    private final ResourceKey<Biome>[][] RIVER_BIOMES_VARIANT = RegionUtil.getSecondaryRiverBiomeVariant();
    private final ResourceKey<Biome>[][] SWAMP_BIOMES = RegionUtil.getSecondarySwampBiome();
    private final ResourceKey<Biome>[][] OCEANS = RegionUtil.getSecondaryOceanBiome();
    ...
    private void addOffCoastBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> builder) {
        this.addSurfaceBiome(builder, this.temperatures[0], this.FULL_RANGE, this.mushroomFieldsContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryIslandBiome(0)) ? RegionUtil.getSecondaryIslandBiome(0) :Biomes.MUSHROOM_FIELDS);
        this.addSurfaceBiome(builder, this.temperatures[1], this.FULL_RANGE, this.mushroomFieldsContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryIslandBiome(1)) ? RegionUtil.getSecondaryIslandBiome(1) :Biomes.MUSHROOM_FIELDS);
        this.addSurfaceBiome(builder, this.temperatures[2], this.FULL_RANGE, this.mushroomFieldsContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryIslandBiome(2)) ? RegionUtil.getSecondaryIslandBiome(2) :Biomes.MUSHROOM_FIELDS);
        this.addSurfaceBiome(builder, this.temperatures[3], this.FULL_RANGE, this.mushroomFieldsContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryIslandBiome(3)) ? RegionUtil.getSecondaryIslandBiome(3) :Biomes.MUSHROOM_FIELDS);
        this.addSurfaceBiome(builder, this.temperatures[4], this.FULL_RANGE, this.mushroomFieldsContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryIslandBiome(4)) ? RegionUtil.getSecondaryIslandBiome(4) :Biomes.MUSHROOM_FIELDS);
    ...
    private void addMidSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> builder, Climate.Parameter weirdness) {
        ResourceKey<Biome> stoneBeachCold = RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryStoneShoreBiome(true)) ? RegionUtil.getSecondaryStoneShoreBiome(true) : Biomes.STONY_SHORE;
        ResourceKey<Biome> stoneBeachHot = RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryStoneShoreBiome(false)) ? RegionUtil.getSecondaryStoneShoreBiome(false) : Biomes.STONY_SHORE;
    ...
    private void addUndergroundBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> builder) {
        this.addUndergroundBiome(builder, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(-1.0F, -0.79F), this.FULL_RANGE, Climate.Parameter.span(-1.0F, 0.0F), 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryCaveBiome(2)) ? RegionUtil.getSecondaryCaveBiome(2) : Biomes.LUSH_CAVES);
        this.addUndergroundBiome(builder, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(-1.0F, -0.79F), this.FULL_RANGE, Climate.Parameter.span(0.0F, 1.0F), 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryCaveBiome(7)) ? RegionUtil.getSecondaryCaveBiome(7) : Biomes.DRIPSTONE_CAVES);

        this.addUndergroundBiome(builder, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(0.775F, 1.0F), this.FULL_RANGE, Climate.Parameter.span(-1.0F, 0.0F), 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryCaveBiome(6)) ? RegionUtil.getSecondaryCaveBiome(6) : Biomes.DRIPSTONE_CAVES);
        this.addUndergroundBiome(builder, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(0.775F, 1.0F), this.FULL_RANGE, Climate.Parameter.span(0.0F, 1.0F), 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryCaveBiome(7)) ? RegionUtil.getSecondaryCaveBiome(7) : Biomes.DRIPSTONE_CAVES);

        this.addUndergroundBiome(builder, this.FULL_RANGE, Climate.Parameter.span(-1.0F, -0.69F), this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(-1.0F, 0.0F), 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryCaveBiome(1)) ? RegionUtil.getSecondaryCaveBiome(1) : Biomes.LUSH_CAVES);
        this.addUndergroundBiome(builder, this.FULL_RANGE, Climate.Parameter.span(-1.0F, -0.69F), this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(0.0F, 1.0F), 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryCaveBiome(5)) ? RegionUtil.getSecondaryCaveBiome(5) :  Biomes.LUSH_CAVES);

        this.addUndergroundBiome(builder, this.FULL_RANGE, Climate.Parameter.span(0.65F, 1.0F), this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(-1.0F, 0.0F), 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryCaveBiome(4)) ? RegionUtil.getSecondaryCaveBiome(4) : Biomes.LUSH_CAVES);
        this.addUndergroundBiome(builder, this.FULL_RANGE, Climate.Parameter.span(0.65F, 1.0F), this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(0.0F, 1.0F), 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryCaveBiome(5)) ? RegionUtil.getSecondaryCaveBiome(5) : Biomes.LUSH_CAVES);

        this.addBottomBiome(builder, this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.erosions[0], this.erosions[1]), this.FULL_RANGE, 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryCaveBiome(3)) ? RegionUtil.getSecondaryCaveBiome(3) : Biomes.DEEP_DARK);
        this.addBottomBiome(builder, this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.erosions[2], this.erosions[3]), this.FULL_RANGE, 0.0F, RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryCaveBiome(8)) ? RegionUtil.getSecondaryCaveBiome(8) : Biomes.DEEP_DARK);
    }
    ...
    private ResourceKey<Biome> maybePickToweringCliffsBiome(int temperature, int humidity, Climate.Parameter weirdness, ResourceKey<Biome> fallbackBiome) {
        ResourceKey<Biome> resourceKey = RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryShatteredCliffBiome()) ? RegionUtil.getSecondaryShatteredCliffBiome() : Biomes.WINDSWEPT_SAVANNA;
    ...
    private ResourceKey<Biome> pickBeachBiome(int temperature) {
        if (temperature == 0) {
            return RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryBeachBiome(temperature)) ? RegionUtil.getSecondaryBeachBiome(temperature) : Biomes.SNOWY_BEACH;
        }
        else if (temperature == 1) {
            return RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryBeachBiome(temperature)) ? RegionUtil.getSecondaryBeachBiome(temperature) : Biomes.BEACH;
        }
    ...
    private ResourceKey<Biome> pickPeakBiome(int temperature, int humidity, Climate.Parameter weirdness) {
        if (temperature == 0) {
            if(weirdness.max() < 0L) {
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryPeakBiome(temperature)) ? RegionUtil.getSecondaryPeakBiome(temperature) : Biomes.JAGGED_PEAKS;
            }
            else{
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryPeakBiomeVariant(temperature)) ? RegionUtil.getSecondaryPeakBiomeVariant(temperature) : Biomes.FROZEN_PEAKS;
            }
        }
        else if (temperature == 1) {
            if(weirdness.max() < 0L) {
            ...
            if(weirdness.max() < 0L) {
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryPeakBiome(temperature)) ? RegionUtil.getSecondaryPeakBiome(temperature) : Biomes.STONY_PEAKS;
            }
            else{
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryPeakBiomeVariant(temperature)) ? RegionUtil.getSecondaryPeakBiomeVariant(temperature) : Biomes.STONY_PEAKS;
            }
        }
        else{
            if(weirdness.max() < 0L) {
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryPeakBiome(temperature)) ? RegionUtil.getSecondaryPeakBiome(temperature) : Biomes.BADLANDS;
            }
            else{
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondaryPeakBiomeVariant(temperature)) ? RegionUtil.getSecondaryPeakBiomeVariant(temperature) : Biomes.WOODED_BADLANDS;
            }
        }
    }
    ...
    private ResourceKey<Biome> pickSlopeBiome(int temperature, int humidity, Climate.Parameter weirdness) {
        if (temperature == 0) {
            if(weirdness.max() < 0L) {
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondarySlopeBiome(temperature)) ? RegionUtil.getSecondarySlopeBiome(temperature) : Biomes.SNOWY_SLOPES;
            }
            else{
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondarySlopeBiomeVariant(temperature)) ? RegionUtil.getSecondarySlopeBiomeVariant(temperature) : Biomes.GROVE;
            }
        }
        else if (temperature == 1) {
            if(weirdness.max() < 0L) {
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondarySlopeBiome(temperature)) ? RegionUtil.getSecondarySlopeBiome(temperature) : Biomes.GROVE;
            }
            else{
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondarySlopeBiomeVariant(temperature)) ? RegionUtil.getSecondarySlopeBiomeVariant(temperature) : Biomes.SNOWY_SLOPES;
            }
        }
        else if (temperature == 2) {
            if(weirdness.max() < 0L) {
            ...
            if(weirdness.max() < 0L) {
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondarySlopeBiome(temperature)) ? RegionUtil.getSecondarySlopeBiome(temperature) : Biomes.STONY_PEAKS;
            }
            else{
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondarySlopeBiomeVariant(temperature)) ? RegionUtil.getSecondarySlopeBiomeVariant(temperature) : Biomes.STONY_PEAKS;
            }
        }
        else{
            if(weirdness.max() < 0L) {
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondarySlopeBiome(temperature)) ? RegionUtil.getSecondarySlopeBiome(temperature) : Biomes.SAVANNA;
            }
            else{
                return RegionUtil.isBiomeEnabled(RegionUtil.getSecondarySlopeBiomeVariant(temperature)) ? RegionUtil.getSecondarySlopeBiomeVariant(temperature) : Biomes.SAVANNA;
            }
        }
    }
