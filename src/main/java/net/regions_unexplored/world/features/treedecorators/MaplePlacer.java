...
public class MaplePlacer extends TrunkVineDecorator {
	public static final MaplePlacer INSTANCE = new MaplePlacer();
	public static com.mojang.serialization.Codec<MaplePlacer> codec;
	...
	public void place(TreeDecorator.Context context) {
		...
		context.setBlock(px1, RegionsUnexploredBlocks.MAPLE_LEAVES.get().defaultBlockState());
