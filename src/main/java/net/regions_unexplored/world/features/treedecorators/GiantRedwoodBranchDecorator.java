...
public class GiantRedwoodBranchDecorator extends TrunkVineDecorator {
	...
	public static com.mojang.serialization.Codec<GiantRedwoodBranchDecorator> codec;
	...
	public void place(Context context) {
		for(int i = 9; i < context.logs().size(); i++){
			int random1 = context.random().nextInt(17);
			int random2 = context.random().nextInt(17);
			int random3 = context.random().nextInt(17);
			int random4 = context.random().nextInt(17);
		if (random1 == 0) {
